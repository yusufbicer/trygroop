...
const Footer = () => {
  ...
  return (
    <footer className="bg-groop-darkest border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-white/60 text-sm">
              Simplifying imports with AI-powered shipping documentation and payment consolidation services.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="#how-it-works" className="text-white/60 hover:text-white transition-colors text-sm">
                  How It Works
                </Link>
              </li>
              <li>
